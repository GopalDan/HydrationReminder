...
/*
 * This class is for scheduling the Job
 * So basically, While using FirebaseJobDispatcher to schedule a job, you have to do 2 things-
 * 1  Create a class that extends JobService where you define your job i.e. what your job does
 * 2  Create a helper class where you define to schedule your job using FirebaseJobDispatcher
 * 3 Finally inside MainActivity call step 2 schedule method to schedule it
 */
